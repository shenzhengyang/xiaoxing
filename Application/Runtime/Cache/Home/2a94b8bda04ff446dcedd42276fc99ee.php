...
<head>
	...
	jQuery(function(){
        ...
        $("#login_bt").bind("click",function(){
           ...
           $("#loginIn").slideToggle("slow");
        });
        $(".regist a").click(function(){
            location="index.php/Index/regist.html"
        });
        //验证登录
        $("#login").click(function(){
            $.post("index.php/Index/login",$(".form-signin").serialize(),function(data,status){
                console.log(data);
                var json_data=JSON.parse(data);
                if(json_data[0].username!=null){
                    $("#login_bt").text("欢迎 "+json_data[0].username+"!");
                    $("#login_bt").css({
                        color:"#428bca",
                        backgroundColor:"#333"
                    });
        ...
        $("#forgotpass").click(function(){
           location="<?php echo U('Index/changepass');?>";
        });
    });
...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
			...
			<ul class="nav navbar-nav" style="margin-left:60%;"> 
                <li id="username"><a id="login_bt" href="#" style="border:1px solid #ffffff;" >登录</a></li>
            </ul>
        </div><!--/.nav-collapse -->
    </div>
</nav>

<div class="container" style="display: none;" id="loginIn">

    <form class="form-signin" action="http://localhost:8080/testWeb/LoginIn">
        ...
        <div class="regist">
            <label style="width:100%;">
                还没有账号?<a herf="#" style="color:#428bca;">马上注册</a>
            </label>
        </div>
    </form>
