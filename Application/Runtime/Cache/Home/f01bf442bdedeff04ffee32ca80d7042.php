...
<head>
	...
	<link href="../../Public/Css/HomeCss/position.css" rel="stylesheet">
	<!-- Custom javascript for this template -->
	<script src="../../Public/Js/jquery.js"></script>
	<script src="../../Public/Js/echarts.min.js"></script>
	<script src="../../Public/Js/HomeJs/position.js"></script>
		...
		<div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
			...
			<table class="table table-hover" id="top2">
				...
				<?php if(is_array($position)): $i = 0; $__LIST__ = $position;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$position): $mod = ($i % 2 );++$i;?><tr>
						...
						<td><?php echo ($position['lng']); ?></td>
						<td><?php echo ($position['speed']); ?></td>
						<td><?php echo ($position['eid']); ?></td>
						<td><?php echo ($position['inrail']); ?></td>
						<td><?php echo ($position['bettery']); ?></td>
